...
export default function AuthLayout({
  ...
  return (
    <div className="relative flex h-screen overflow-hidden w-full p-4 bg-sidebar">
      ...
      {/* Left Side */}
      <div className="hidden md:flex items-center justify-center w-1/2 bg-sidebar">
      ...
      {/* Right Side */}
      <div className="z-100 w-full md:w-1/2 bg-background border shadow-xl rounded-xl flex overflow-y-auto no-scrollbar">
